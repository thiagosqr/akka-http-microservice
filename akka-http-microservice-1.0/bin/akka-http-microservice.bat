@REM akka-http-microservice launcher script
@REM
@REM Environment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM AKKA_HTTP_MICROSERVICE_config.txt found in the AKKA_HTTP_MICROSERVICE_HOME.
@setlocal enabledelayedexpansion

@echo off

if "%AKKA_HTTP_MICROSERVICE_HOME%"=="" set "AKKA_HTTP_MICROSERVICE_HOME=%~dp0\\.."

set "APP_LIB_DIR=%AKKA_HTTP_MICROSERVICE_HOME%\lib\"
...
set "CFG_FILE=%AKKA_HTTP_MICROSERVICE_HOME%\AKKA_HTTP_MICROSERVICE_config.txt"
set CFG_OPTS=
if exist %CFG_FILE% (
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running akka-http-microservice.
  echo.
...
"%_JAVACMD%" !_JAVA_OPTS! !AKKA_HTTP_MICROSERVICE_OPTS! -cp "%APP_CLASSPATH%" %MAIN_CLASS% !_APP_ARGS!
